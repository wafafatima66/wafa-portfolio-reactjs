...
const Courses = () => {
  ...
  return (
    <section className="min-h-screen relative overflow-hidden bg-black py-24 px-4 sm:px-6">
      {/* Background HUD Grid */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter uppercase leading-none italic">
            ACADEMIC_
          ...
          <div className="w-full relative">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                animate="visible"
                exit="exit"
                className="relative bg-white/[0.02] border border-white/10 p-6 sm:p-8 md:p-14 backdrop-blur-sm overflow-hidden"
              >
                {/* Tactical Corners */}
                ...
                <div className="relative z-10 grid md:grid-cols-12 gap-10 items-start">
                  ...
                  <div className="md:col-span-4 flex flex-col gap-6">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-xs text-gray-500 mt-2 uppercase">
                        Verified_Status: [{String(courses[currentIndex]?.Status || courses[currentIndex]?.status || "COMPLETED").toUpperCase()}]
                      </p>
                    </div>
                  ...
                  <div className="md:col-span-8 space-y-8">
                    <div>
                      <h3 className="text-2xl sm:text-3xl md:text-5xl font-black uppercase italic text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-gray-600 tracking-tighter leading-tight mb-6">
                        {courses[currentIndex]?.name}
                      </h3>
                      <p className="text-gray-400 text-base sm:text-lg leading-relaxed border-l border-fuchsia-500/50 pl-6 italic">
                    ...
                    {courses[currentIndex]?.skills && (
                      <div className="pt-4">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <p className="text-[10px] font-mono font-bold text-gray-500 uppercase tracking-[0.3em]">
